...
then
    ...
    docker run -d -p 14268:14268 -p 16686:16686 --name "${JAEGER_CONTAINER_NAME}" docker.io/jaegertracing/all-in-one:1.31
    docker run -d -p 3000:3000 --name="${GRAFANA_CONTAINER_NAME}" docker.io/grafana/grafana:9.2.1
